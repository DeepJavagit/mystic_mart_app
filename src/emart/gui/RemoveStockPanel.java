 ...
 * @author Acer
 */
public class RemoveStockPanel extends javax.swing.JFrame {

    /**
     * Creates new form RemoveStockPanel
     */
    DefaultTableModel tn;
    public RemoveStockPanel() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 190, 1160, 580));
        ...
        jLabel6.setText("Delete Item Panel");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String pid = tn.getValueAt(row, 0).toString();
        try{
            if(ProductDao.deleteProduct(pid)){
                 JOptionPane.showMessageDialog(null, "Delete Product Succesfully");
                 tn.setRowCount(0);
                 loadStock();
                 return;
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoveStockPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoveStockPanel().setVisible(true);
            }
        });
    }
    ...
    private void loadStock() {
      try{
       List<ProductPojo> sp = ProductDao.getProductDetails();
             tn = (DefaultTableModel)jProduct.getModel();
