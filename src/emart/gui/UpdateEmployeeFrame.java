...
public class UpdateEmployeeFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jcEmpId.setFont(new java.awt.Font("Verdana", 1, 15)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            ep.setSal(Integer.parseInt(txtSal.getText()));
            boolean result = EmpDao.updateEmployee(ep);
            if(result){
                JOptionPane.showMessageDialog(null,"Record Updated is Sussefull","Updated",JOptionPane.ERROR_MESSAGE);
            }
            else{
                JOptionPane.showMessageDialog(null,"Updation Not Done","Updation",JOptionPane.ERROR_MESSAGE);
            }
